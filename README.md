## [signum-network/signum-node](https://github.com/signum-network/signum-node/) Containerized Dedicated Server  
[![Docker Image CI](https://github.com/gittrekt/signum-node_container_buildbot/actions/workflows/docker.yml/badge.svg?event=schedule)](https://github.com/gittrekt/signum-node_container_buildbot/actions/workflows/docker.yml)

Check the offical signum-network for information  

<details>
<summary>Signum-Node README</summary>
